...
const Left = ({ data }) => {
  ...
  return (
    <div className="bg-cyan-800 pt-16 pl-[8.33%]  max-h-max flex gap-5 flex-row pr-10 relative overflow-y-hidden">
      {/* <div className="bg-cyan-800 pt-16 pl-[8.33%] 7md:min-h-screen max-h-max flex gap-5 flex-col pr-10 relative overflow-y-hidden"> */}
      <div>
      ...
      <div className="lg:flex hidden gap-5 flex-wrap mt-[30px] mr-[30px] ">
